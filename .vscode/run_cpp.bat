...
%CPPBIN_PATH%\c++ -fdiagnostics-color=always "%1\%2.cpp" -o "%1\%2" -D_LOCAL_ -D_DEBUG -O2 -std=c++17 -iquote "%1\template" -I . -I "%1\tools\lib-cpp" -Wall -Wextra -Wconversion -Wpedantic -Wparentheses || goto end
