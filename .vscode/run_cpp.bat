...
%CPPBIN_PATH%\c++ -fdiagnostics-color=always "%1\%2.cpp" -o "%1\%2" -DLOCAL_ -O2 -std=c++17 -I "%1\tools\lib-cpp" -I "%1\lib\testlib" -Wall -Wextra -Wconversion -Wpedantic -Wparentheses || goto end
